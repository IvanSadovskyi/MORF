...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <base href="[[++site_url]]">
        <title>MORF - Page not found</title>
        ...
        <div id="smooth-wrapper" class="page" data-scroller>
            <div id="smooth-content">
                <main style="background-color: transparent;">
                    <section class="page-not-found container" data-section="dark">
                        <div class="page-not-found__wrap">
                            <img src="/assets/img/error-code.svg" class="page-not-found__404-img" alt="">
                            <p>The page you are looking for does not exist in our universe<br>Try going back to our home page</p>
                        </div>
                        <a class="btn btn--secondary btn--right" href="/">
