            ...
            <div id="smooth-content">
                <main>
                    ...
                    <div class="work-texts container">
                        <div class="introduction">
                            ...
                            <div class="introduction__wrap">
                                <p>NORAH, a conceptual luxury organic beauty brand, features a cohesive identity across its skincare, haircare, and body care lines. We designed an elegant logo, visual identity, and sustainable packaging, embodying NORAH’s organic, vegan, and cruelty-free ethos.</p>
                            </div>
                        </div>
                    </div>
                    <section class="work-texts container">
                        <div class="row row-g96 row-nw">
                            ...
                            <div class="col-1-2 section-texts" style="margin-bottom: 0; display: flex; justify-content: center; flex-direction: column;">
                                ...
                                <p>NORAH’s new logo, crafted with the Montserrat Alternates font, exudes elegance and modernity. The clean, minimalist design reflects the brand’s organic luxury, with balanced spacing ensuring a refined and approachable aesthetic.</p>
                            </div>
                        </div>
                    </section>
                    <section class="container picture">
                    ...
                    <section class="other-project container">
                        <div class="row row-g96 row-nw">
                            <div class="col-1-2">
                                <img src="/assets/img/cases/griffith-observatory-rebranding/griffith-cover.png" alt="">
                            </div>
                            <div class="col-1-2">
                                <div class="other-project__wrap">
                                    <span>Next project</span>
                                    <h2><strong>Griffith Observatory<br>Rebranding</strong></h2>
                                    <a href="/case-griffith-observatory-rebranding" class="btn btn--arrow btn--right btn--primary">
